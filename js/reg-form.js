...
new Vue({
   ...
   methods: {
         ...
         var handler = PaystackPop.setup({
            ...
            callback: function (response) {
               swal("Payment successful", response.reference, "success")
                  .then(function () {
                     this.payment_id = response.reference;
                     this.submitForm();
                  }.bind(this));
            }.bind(this),
            onClose: function () {
               /**Simulate Submit */
               this.submitForm();
               swal("Payment Error", "Sorry, " + this.name + ", The payment was not successful", "error");
            }.bind(this)
         });
      ...
      submitForm: function () {
         var form_data = new FormData(document.getElementById("awlo-pageant-form"));
         console.log("Form Data: ", formData);

         $.ajax({
            url: window.form_target,
            data: form_data,
            processData: false,
            contentType: false,
            type: 'POST',
